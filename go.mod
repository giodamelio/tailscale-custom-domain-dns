...
require (
	...
	gvisor.dev/gvisor v0.0.0-20230822211915-e8c1fff214d0 // indirect
	inet.af/peercred v0.0.0-20210906144145-0893ea02156a // indirect
	nhooyr.io/websocket v1.8.7 // indirect
)

replace gvisor.dev/gvisor => gvisor.dev/gvisor v0.0.0-20230504175454-7b0a1988a28f

replace go4.org/netipx => github.com/go4org/netipx v0.0.0-20230728180743-ad4cb58a6516
